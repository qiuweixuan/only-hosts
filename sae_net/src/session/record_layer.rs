use crate::crypt::cipher::{MessageEncrypter, MessageDecrypter};
...
impl RecordLayer {
    ...
    pub fn decrypt_incoming(&mut self, encr: Message) -> Result<Message, StateChangeError> {
    ...
    pub fn encrypt_outgoing(&mut self, plain: BorrowMessage) -> Result<Message, StateChangeError> {
